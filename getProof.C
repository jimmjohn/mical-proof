...
TProof* getProof::getProofSection(const char *url = "proof://localhost:40000", Int_t nwrks = -1, const char *dir = 0,
...
Int_t getProof::getXrootdPid(Int_t port, const char *subdir)
{
#ifdef WIN32
...
Int_t getProof::checkXrootdAt(Int_t port, const char *host)
{
...
Int_t getProof::checkXproofdAt(Int_t port, const char *host)
{
...
Int_t getProof::startXrootdAt(Int_t port, const char *exportdirs, Bool_t force)
{
...
Int_t getProof::killXrootdAt(Int_t port, const char *id)
{
...
int getProof::getDebugEnum(const char *what)
{
